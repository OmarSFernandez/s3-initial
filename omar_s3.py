...
object_key = 'bg'
file_name = 'babygirl.jpeg'

print('Uploading some data to {} with key: {}'.format(
    bucket_name, object_key))
response = s3client.upload_file(file_name, bucket_name, object_key)
#print('File Uploaded = {}'.format(response)
#s3client.put_object(Bucket=bucket_name, Key=object_key)
